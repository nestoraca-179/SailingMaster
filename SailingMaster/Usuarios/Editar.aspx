<%@ Page Title="Editar Usuario" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="SailingMaster.Usuarios.Editar" %>
    ...
    <asp:Panel ID="PN_ContainerForm" runat="server" CssClass="form-header">
        ...
        <div class="row">
            <div class="col">
                <div class="controls">
                    <label>Clave</label>
                    <dx:ASPxTextBox ID="TB_Password" runat="server" Theme="Material" Width="100%" Enabled="false">
                        <ValidationSettings ValidationGroup="Usuario" ErrorText="" ValidateOnLeave="false" ErrorTextPosition="Bottom">
                            <RequiredField IsRequired="True" ErrorText="Campo Obligatorio" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
